...
@section('section2')
  <div class="container inline-block">
    <img src="../image/fondo-recital-BN.png" style="width:30%;cursor:zoom-in" onclick="document.getElementById('modal01').style.display='block'">
  ...
  <div class="container inline-block">
    <img src="../image/fondo-recital.png" style="width:30%;cursor:zoom-in" onclick="document.getElementById('modal02').style.display='block'">
  ...
  <div class="container inline-block">
    <img src="../image/fondo-recital2.jpg" style="width:30%;cursor:zoom-in" onclick="document.getElementById('modal03').style.display='block'">
  ...
  <div class="container inline-block">
    <img src="../image/fondo-recital3.jpg" style="width:30%;cursor:zoom-in" onclick="document.getElementById('modal04').style.display='block'">
  ...
  <div class="container inline-block">
    <img src="../image/fondo-recital4.png" style="width:30%;cursor:zoom-in" onclick="document.getElementById('modal05').style.display='block'">
